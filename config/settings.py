...
SECRET_KEY = 'django-insecure-zy*7v%ilt-dt-+9$r8%_fyxq#1ay+6il@mxm%#6**v-_&^#f+3'
...
INSTALLED_APPS = [
    ...
    # Apps du projet
    "rest_framework",
    "django_filters",  # <- DOIT ÊTRE PRÉSENT
    "drf_spectacular",
    "products",
]

REST_FRAMEWORK = {
    # ... garde tes options existantes ...
    ...
    # (ces 2 lignes peuvent rester, elles sont bien)
